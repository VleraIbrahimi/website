...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      ...
      <div class="info">
        <h2>Pharmasept Baby Care Mini Essentials</h2>
        ...
        <p id="pershkrimi">
       Paketa mini për foshnje me produkte thelbësore për pastrim dhe hidratim të përditshëm, e sigurt që nga dita e parë.
        <div class="butonat">
            <button>-</button>
