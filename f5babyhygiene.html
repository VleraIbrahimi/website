...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="babyhygiene5.png" alt="">
      </div>

      <div class="info">
        <h2>Momcozy Baby Oral Cleaner 40 pcs</h2>
        ...
        <p id="pershkrimi">
       Pastruesi i gjuhës për fëmijë Momcozy siguron higjienë të plotë orale me kokë 360°, garzë mjekësore dhe paketim individual për përdorim të sigurt dhe të lehtë.
        </p>
        <div class="butonat">
            <button>-</button>
