...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      ...
      <div class="info">
        <h2>Plasmon Biskota me Qumësht 12m+ 320 g</h2>
        ...
        <p id="pershkrimi">
      Recetë me vitamina dhe kripëra minerale të zgjedhura, që shkrihet lehtësisht në gojë dhe në qumësht, pa vaj palme dhe me 6 mini porcione praktike për përdorim kudo.
        <div class="butonat">
            <button>-</button>
