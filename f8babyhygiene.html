...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="babyhygiene8.png" alt="">
      </div>

      <div class="info">
        <h2>Bambo nature Swim Pants</h2>
        ...
        <p id="pershkrimi">
            Bambo Nature Swim Pants janë pantallona noti ekologjike, të dizajnuara për të siguruar mbrojtje dhe rehati maksimale për foshnjat dhe fëmijët e vegjël gjatë kohës së tyre në ujë.
       </p>
            <button>-</button>
