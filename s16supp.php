...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="suplimente16.png" alt="">
      </div>

      <div class="info">
        <h2>Gold-Vit D3 Junior</h2>
        ...
        <p id="pershkrimi">
       Formulim me vitaminë D3 për fëmijë mbi 3 vjeç që mbështet kockat dhe imunitetin, merret një bustinë në ditë pas ushqimit, e tretur në gojë ose me ujë.
        <div class="butonat">
            <button>-</button>
