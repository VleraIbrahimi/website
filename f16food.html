...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="food16.png" alt="">
      </div>

      <div class="info">
        <h2>Plasmon Merende me Fruta dhe Drithëra 6m+ 240 g</h2>
        ...
        <p id="pershkrimi">
    Merende kremoze me fruta dhe drithëra 100% italiane, me vitaminë C dhe qumësht të fermentuar, pa sheqerna të shtuara, e përshtatshme për fëmijët mbi 6 muajsh dhe me paketim të rimbyllshëm praktik.
        <div class="butonat">
            <button>-</button>
