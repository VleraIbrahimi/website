...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="dermo4.png" alt="">
      </div>

      <div class="info">
        <h2>Nuxe Reve de Miel Honey Lip Balm</h2>
        ...
        <p id="pershkrimi">
        Shijoni formulën ikonike të këtij balsami ushqyes për buzët me përbërës të çmuar të bletëve (Mjaltë, Propolisi).

        Formula e tij ndihmon në riparimin dhe zbutjen e buzëve shumë të thata dhe të ndjeshme. Ndihmon menjëherë në lehtësimin e ndjesive të shqetësimit dhe ofron një “efekt salcë” për buzët tuaja.
