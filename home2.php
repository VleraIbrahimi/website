...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      ...
      <div class="info">
        <h2>Moonkie First Bites Gift Set</h2>
        ...
        <p id="pershkrimi">
        Seti i ushqyerjes për foshnje prej silikoni ofron enë të sigurta, të qëndrueshme dhe të lehta për pastrim, duke ndihmuar në kalimin nga ushqyerja me asistencë në atë të pavarur.
        <div class="butonat">
            <button>-</button>
