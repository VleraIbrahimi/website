...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="suplimente11.png" alt="">
      </div>

      <div class="info">
        <h2>TFertyBiotic 30tabs</h2>
        ...
        <p id="pershkrimi">
      FertyBiotic Woman ndihmon në përmirësimin e fertilitetit tek gratë, falë përbërjes unike me vitamina, minerale, antioksidantë dhe probiotikë.
        <div class="butonat">
            <button>-</button>
