...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="podukt14.png" alt="">
      </div>

      <div class="info">
        <h2>Nuuroo Anna Sunglasses UV400 2-8 Years – Dusty Green</h2>
        ...
        <p id="pershkrimi">
       Syzet Nuuroo Anna UV400 ofrojnë mbrojtje të plotë nga dielli për fëmijët 2-8 vjeç, me dizajn të butë dhe të rehatshëm për përdorim të përditshëm.
        <div class="butonat">
            <button>-</button>
