...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="dermo1.png" alt="">
      </div>

      <div class="info">
        <h2>Nuxe Very Rose Lip Balm 15g</h2>
        ...
        <p id="pershkrimi">
        Një krem me nota delikate trëndafili për të gjitha llojet e lëkurës, madje edhe ato më të ndjeshmet.

        Hidraton dhe zbut çdo ndjenjë shtrëngimi dhe mbron duart nga agresorët e jashtëm (era, i ftohti).

        97% e përbërësve janë me origjinë natyrale.
        Prodhuar në Francë.
        </p>
        <div class="butonat">
            <button>-</button>
