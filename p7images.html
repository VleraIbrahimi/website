...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      ...
      <div class="info">
        <h2>Suavinex Krem antistrija 250ml</h2>
        ...
        <p id="pershkrimi">
        Krem per tu mbrojtur nga strijat.
        Per perdorim te jashtem , aplikohet dy here ne dite.
        Me formulim acidi hialuronik.
        89% e ingredienteve natyral
        </p>
        <div class="butonat">
            <button>-</button>
