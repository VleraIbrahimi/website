...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="suplimente7.png" alt="">
      </div>

      <div class="info">
        <h2>Together Health Mushroom 5 x 60 Kapsula</h2>
        ...
        <p id="pershkrimi">
       Në një kombinim të vetëm përfitohet nga: Lion’s Mane; Reishi; Chaga & Shiitake; Maitake.
        <div class="butonat">
            <button>-</button>
