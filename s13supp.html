...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="suplimente13.png" alt="">
      </div>

      <div class="info">
        <h2>Wellbaby Vitamin D drops</h2>
        ...
        <p id="pershkrimi">
       Pikat me vitaminë D3 për fëmijët deri në 4 vjeç, me bazë vaj ulliri, ndihmojnë zhvillimin e kockave, dhëmbëve dhe imunitetin.
        <div class="butonat">
            <button>-</button>
