...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="babyhygiene4.png" alt="">
      </div>

      <div class="info">
        <h2>Momcozy Nose Saline Wips for babies</h2>
        ...
        <p id="pershkrimi">
            Pecetat e lagura Momcozy janë formuluar posaçërisht për të siguruar pastrim të butë dhe efektiv për kanalet delikate të hundës së foshnjës suaj.
