...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="suplimente14.png" alt="">
      </div>

      <div class="info">
        <h2>Wellbaby Multi-vitamin Liquid</h2>
        ...
        <p id="pershkrimi">
      Shurupi me vitaminat A, C, D dhe hekur për fëmijë 6 muaj – 4 vjeç, mbështet zhvillimin e kockave, shikimit dhe funksioneve njohëse.
        <div class="butonat">
            <button>-</button>
