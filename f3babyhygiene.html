...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="babyhygiene3.png" alt="">
      </div>

      <div class="info">
        <h2>Momcozy Elite Baby Kit</h2>
        ...
        <p id="pershkrimi">
            Kategoritë: Aksesor per larje, Aspirator, Higjena femijes, Kujdesi ndaj femijes, Mom&Bliss
            Etiketa: aspirator, baby, higjena, mom, momcozy, set, termometer, thonjte
            Marka: Momcozy
