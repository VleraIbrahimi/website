...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="laroche10.png" alt="">
      </div>

      <div class="info">
        <h2> Sesderma C-Vit Radiance Glowing Fluid </h2>
        ...
        <p id="pershkrimi">
Sesderma C-Vit Radiance Glowing Fluid është një krem​-xhel i cili i jep shkëlqim dhe vitalitet të menjëhershëm lëkurës së dehidratuar me shenjat e para të plakjes. Kjo formulë e fuqishme e vitaminës C nga ekstrakti natyral i portokallit ushqen lëkurën tuaj duke siguruar hidratim të thellë. Vetitë antioksiduese ndihmojnë për të barazuar tonin e lëkurës, duke zvogëluar pamjen e njollave të errëta dhe duke zbutur strukturën e lëkurës.
        </p>
        <div class="butonat">
            <button>-</button>
