...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="babyhygiene10.png" alt="">
      </div>

      <div class="info">
        <h2>Suavinex Xhel Shampo Syndet Formula Pa sapun</h2>
        ...
        <p id="pershkrimi">
      Xhel shampo syndet (pa sapun) per trupin dhe floket e bebit.
      I testuar klinikisht nen kontroll deramtologjik.
      Me acide yndyrore te kokosit qe evitojne tharjen dhe irritimin.
      Me ekstrakt kamomili e bisabolol me veti qetesuese.
      Floket e bebit zbuten ,krihen lehtesisht ,dhe shkelqejne fale provitamines B5
        </p>
        <div class="butonat">
            <button>-</button>
