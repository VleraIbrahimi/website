...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      ...
      <div class="info">
        <h2>Baby Earmuff Noise Reduction Hearing Protection</h2>
        ...
        <p id="pershkrimi">
       Kufje veshi të buta dhe të sigurta për foshnjat, që bllokojnë zhurmat dhe mbrojnë dëgjimin në çdo ambient.
        <div class="butonat">
            <button>-</button>
