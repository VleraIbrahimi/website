...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="suplimente10.png" alt="">
      </div>

      <div class="info">
        <h2>Supplements for bones/yanola Os 30 tab</h2>
        ...
        <p id="pershkrimi">
       Humana Benelife D3 është suplement me vitaminë D3 dhe DHA për rritje, zhvillim të shëndetshëm që nga lindja.
        <div class="butonat">
            <button>-</button>
