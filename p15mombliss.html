...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="produkt16.png" alt="">
      </div>

      <div class="info">
        <h2>Chicco Electric Toothbrush Pink +3 Years – Blue</h2>
        ...
        <p id="pershkrimi">
       Furça Elektrike Chicco për fëmijë 3+ ofron pastrim të butë dhe argëtues të dhëmbëve me fije të buta dhe kokë të vogël.
        <div class="butonat">
            <button>-</button>
