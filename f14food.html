...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="food14.png" alt="">
      </div>

      <div class="info">
        <h2>Plasmon Mish Pule i Homogjenizuar 6m+ 2×80 g</h2>
        ...
        <p id="pershkrimi">
      Mish pule i homogjenizuar Plasmon, i gatuar me avull, me aromë delikate dhe pa kripë, ngjyrues apo konservantë – ideal për fazat e para të ushqyerjes.
        <div class="butonat">
            <button>-</button>
