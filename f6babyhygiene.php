...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="babyhygiene6.png" alt="">
      </div>

      <div class="info">
        <h2>Kin baby body oil</h2>
        ...
        <p id="pershkrimi">
       Ky vaj masazhi 100% natyral me 12 ekstrakte ushqyese qetëson, hidraton dhe mbron lëkurën delikate të foshnjës pa kimikate të ashpra.
        </p>
        <div class="butonat">
            <button>-</button>
