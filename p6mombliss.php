...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      ...
      <div class="info">
        <h2>Neno Bambino Wireless Video Baby Monitor</h2>
        ...
        <p id="pershkrimi">
       Neno Bambino është një monitor elektronik për foshnje me një marrës që mund të çiftëzohet me disa kamera (deri në 4 pajisje) për të vepruar si një pajisje mbikëqyrjeje në shtëpi.
        </p>
        <div class="butonat">
            <button>-</button>
