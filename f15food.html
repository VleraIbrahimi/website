...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="food15.png" alt="">
      </div>

      <div class="info">
        <h2>Plasmon Vaj Ulliri Eksta i Virgjër 250 ml</h2>
        ...
        <p id="pershkrimi">
        Vaj ekstra i virgjër Plasmon, 100% nga ullinj italianë, me shije të përshtatshme për fëmijë dhe i pasur me vitaminat E, A dhe D.
        <div class="butonat">
            <button>-</button>
