...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="pregnant.png" alt="">
      </div>

      <div class="info">
        <h2>Mustela Strech Marks Cream 3-in-1 150ml</h2>
        ...
        <p id="pershkrimi">
       Kremi për strijat Mustela Maternité 3 në 1 parandalon shfaqjen e strijave gjatë shtatzënisë, duke hidratuar thellësisht, përmirësuar elasticitetin e lëkurës dhe zbutur ndjenjat e shtrëngimit. Me vaj avokado dhe ekstrakte natyrale si polifenole maracujë dhe hamamelis, përmirëson elasticitetin e lëkurës dhe mbron shtresën hidrolipidike. Glicerina natyrale hidraton dhe mbron lëkurën.
        <div class="butonat">
            <button>-</button>
