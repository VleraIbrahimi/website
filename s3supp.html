...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="suplimente3.png" alt="">
      </div>

      <div class="info">
        <h2>Together Health Eye Defence x 60 Kapsula</h2>
        ...
        <p id="pershkrimi">
      Eye Defence mbron sytë nga drita blu dhe lodhja vizuale falë përzierjes së astaxanthin, zeaxanthin, lutein dhe betacaroten nga burime natyrale.
        <div class="butonat">
            <button>-</button>
