...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="krem.png" alt="">
      </div>

      <div class="info">
        <h2>Embryolisse Lait-Crème Retinol-Like 75 ml</h2>
        ...
        <p id="pershkrimi">
        Embryolisse Lait-Crème Retinol-Like është një krem 5-në-1 që ofron kujdes kundër rrudhave, duke stimuluar sintezën e kolagjenit me përbërës natyral, tërfili francez. Ky produkt vepron si hidratues, bazë grimi, maskë rigjeneruese, krem nate dhe krem trupi rigjallërues. I përshtatshëm për të gjitha llojet e lëkurës, madje edhe për lëkurën e ndjeshme.
        <div class="butonat">
            <button>-</button>
