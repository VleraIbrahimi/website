...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="suplimente2.png" alt="">
      </div>

      <div class="info">
        <h2>Together Health Iodine x 60 Kapsula</h2>
        ...
        <p id="pershkrimi">
       Suplementi Iodine nga alga deti organike mbështet tiroiden, metabolizmin dhe lëkurën me përthithje maksimale falë kombinimit të Jodit me minerale dhe vitamina natyrale.
        <div class="butonat">
            <button>-</button>
