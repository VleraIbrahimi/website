...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="suplimente9.png" alt="">
      </div>

      <div class="info">
        <h2>Optibac pregnancy Probiotics</h2>
        ...
        <p id="pershkrimi">
      Optibac Probiotics Pregnancy është një suplement vegan që mbështet florën intestinale, vaginale dhe imunitetin gjatë shtatzënisë dhe gjidhënies.
        <div class="butonat">
            <button>-</button>
