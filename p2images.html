...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      ...
      <div class="info">
        <h2>Momcozy Compression Socks for Women</h2>
        ...
        <p id="pershkrimi">
        Çorapet e kompresimit për femra Momcozy ofrojnë komprimim të shkallëzuar që ndihet progresiv, i barabartë dhe i sigurt, pa shkaktuar dhimbje për të përmirësuar qarkullimin, për të zvogëluar ënjtjen dhe për të lehtësuar lodhjen e këmbëve.
        </p>
        <div class="butonat">
            <button>-</button>
