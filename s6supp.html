...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="suplimente6.png" alt="">
      </div>

      <div class="info">
        <h2>Together Health Lion's Mane x 60 Kapsula</h2>
        ...
        <p id="pershkrimi">
       Lion’s Mane është një kërpudhë me përfitime të mëdha për shëndetin e trurit , zemrës dhe sistemit tretës me përdorim mijëravjeçar në Kinë , Indi , Japoni dhe Kore.
        <div class="butonat">
            <button>-</button>
