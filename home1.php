...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="maqine.png" alt="">
      </div>

      <div class="info">
        <h2>Babymoov Nutribaby One 4-in-1 Food Prep Maker – Qelqi</h2>
        ...
        <p id="pershkrimi">
        Nutribaby Glass, roboti 4-në-1 me xham dhe çelik inox, rikthehet me programim të saktë për vakte të shëndetshme, të shijshme dhe të përgatitura shpejt për foshnjën tuaj.
        <div class="butonat">
            <button>-</button>
