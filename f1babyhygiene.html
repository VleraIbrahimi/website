...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="babyhygiene1.png" alt="">
      </div>

      <div class="info">
        <h2>Braun Nasal Aspirator 1</h2>
        ...
        <p id="pershkrimi">
        Aspiratori elektrik nazal Braun ndihmon në pastrimin e hundëve të bllokuara shpejt dhe butësisht me dy maja nazale dhe nivele thithjeje, duke e bërë këtë aspirator të përshtatshëm për foshnjat dhe fëmijët e vegjël.
        </p>
        <div class="butonat">
            <button>-</button>
