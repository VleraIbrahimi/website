...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="produkt12.png" alt="">
      </div>

      <div class="info">
        <h2>Momcozy M9 Mobile Flow Hands-Free Breast Pump – Single</h2>
        ...
        <p id="pershkrimi">
       Përjetoni ushqyerjen me gji pa mundim dhe diskrete, kontroll pa duar përmes aplikacionit “Momcozy”, duke ju lejuar të filloni, ndaloni dhe personalizoni seancën tuaj të pompimit pa asnjë shqetësim.
        <div class="butonat">
            <button>-</button>
