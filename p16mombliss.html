...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="produkt17.png" alt="">
      </div>

      <div class="info">
        <h2>Bibs Biberon Qelqi Anti-Colic 110 ml – Sage</h2>
        ...
        <p id="pershkrimi">
       Shishja BIBS prej qelqi borosilikat është rezistente, anti-kolikë, pa mikroplastikë dhe e certifikuar sipas standardeve europiane, me kapacitet 110 ml për foshnjat 0+ muajsh.
        <div class="butonat">
            <button>-</button>
