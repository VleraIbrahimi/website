...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      ...
      <div class="info">
        <h2>Momcozy DinerPal Wooden High Chair For Babies</h2>
        ...
        <p id="pershkrimi">
       Karrigia e Lartë Momcozy DinerPal, e projektuar për t’u rritur me foshnjën nga 6 muaj deri në moshën madhore, ofron 5 mënyra ulëseje nga seti i foshnjës në karrigen e të rriturve dhe mbështet deri në 138 kg.
        <div class="butonat">
            <button>-</button>
