...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="babyhygiene12.png" alt="">
      </div>

      <div class="info">
        <h2>Babyono Thermometer</h2>
        ...
        <p id="pershkrimi">
        Termometri i banjës Babyono është shumë komod dhe i nevojshëm për çdo banjë të porsalindur. Ndihmon për të marrë dhe mbajtur temperaturën e duhur për banjën e fëmijës suaj.

         Është plotësisht i sigurt , sepse kemi përdorur parafinë të ngulitur në një tub të sigurt.

        Shkalla e madhe dhe e lexueshme e bën më të lehtë leximin e lartësisë së temperaturës.

         Falë konstruksionit të lehtë , termometri noton në sipërfaqen e ujit , duke lejuar kontrollin e temperaturës.

        Temperatura e saktë e ujit duhet të jetë rreth 37 gradë Celsius dhe shënohet në shkallë me një buzëqeshje.
