...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="food8.png" alt="">
      </div>

      <div class="info">
        <h2>Holle Red Bee – Pure Frutash me Mollë dhe Luleshtrydhe 8m+</h2>
        ...
        <p id="pershkrimi">
      Pure frutash e shëndetshme për bebe mbi 8 muaj, pa shtesa dhe e përshtatshme si mesvakt i lehtë.
        <div class="butonat">
            <button>-</button>
