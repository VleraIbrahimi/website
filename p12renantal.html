...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="Mommy's Prenantal Multivitamin 45cps.png" alt="">
      </div>
      ...
      <div class="info">
        ...
        <p id="pershkrimi">
        Multivitamina  prenatale ka vitamina dhe lëndë ushqyese thelbësore që i nevojiten foshnjës tuaj për zhvillim, plus probiotikë, xhenxhefil dhe vitaminë B6 për t’ju ndihmuar me gazrat e përzier, kapsllëkun dhe barkun e mërzitur.

       -Për përdorim para, gjatë dhe pas shtatzënisë.
       -Vitaminat esenciale për bebe me folate bio-disponueshme (Quatrefolic ®)
       -Pa ngjyra dhe shije artificiale. Pa qumësht, gluten apo sojë.
       -Vegan dhe jo OMGJ
        </p>
        <div class="butonat">
            <button>-</button>
