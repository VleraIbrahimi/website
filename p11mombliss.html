...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="produkt13.png" alt="">
      </div>

      <div class="info">
        <h2>MAM Original Soother Silicone Trends 2-6 m Turtle/Koala 2 Pc</h2>
        ...
        <p id="pershkrimi">
      MAM Original Night 2-6m, 2 copë, Thithëse dhe biberona për fëmijë, Mbështetuni në një metodë të provuar për qetësimin e foshnjës suaj.
        <div class="butonat">
            <button>-</button>
