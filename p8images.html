...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      ...
      <div class="info">
        <h2>Pharmaguida Mammavit DHA 9655 mg x 30</h2>
        ...
        <p id="pershkrimi">
        Mammavit DHA është një suplement ushqimor i pasur me vitamina , minerale dhe acide yndyrore të pangopura (DHA) , të formuluara për nevojat ushqimore të femrave sidomos gjatë shtatzanisë dhe laktacionit.
        Përmban gjithashtu vitamina B complex , hekur , zink , fluor , jod , selen të nevojshme në shtatëzani si nutrientë ushqyes për nënën dhe fëmijën.
        </p>
        <div class="butonat">
            <button>-</button>
