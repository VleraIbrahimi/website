...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="laroche12.png" alt="">
      </div>

      <div class="info">
        <h2>Caudalie Vinosun High Protection Sun Water SPF 50+ 150ml</h2>
        ...
        <p id="pershkrimi">
     Mbron në mënyrë efektive fytyrën, trupin dhe flokët nga rrezet UVA/UVB duke siguruar një veprim antioksidant edhe për lëkurën më të ndjeshme. Tekstura e saj e padukshme, gjysmë ujë dhe gjysmë vaj, përthithet shpejt pa lënë ndjesi të yndyrshme dhe lë një aromë të butë verore në lëkurë. Një formulë e pastër dhe miqësore për të gjithë familjen!
