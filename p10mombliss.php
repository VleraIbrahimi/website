...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="produkt1.1.png" alt="">
      </div>

      <div class="info">
        <h2>Byzylykët Kundër Mushkonjave – Green</h2>
        ...
        <p id="pershkrimi">
       Byzylyk natyral kundër mushkonjave, i sigurt dhe plot ngjyra për mbrojtjen e fëmijëve gjatë çdo aventure!
        <div class="butonat">
            <button>-</button>
