...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      ...
      <div class="info">
        <h2>Momcozy Baby Hooded Towel & Washcloths Set</h2>
        ...
        <p id="pershkrimi">
       Set peshqirësh me kapuç 8 pjesësh për fëmijë dhe leckë larëse, duke përfshirë aksesorët e banjës së foshnjës: 6 lecka pastrimi për fëmijë (24,5 x 24,5 cm) dhe 2 peshqirë të mëdhenj me kapuç për fëmijë (76,2 x 76,2 cm) që mund të plotësojnë nevojat tuaja ditore.
        <div class="butonat">
            <button>-</button>
