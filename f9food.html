...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="food9.png" alt="">
      </div>

      <div class="info">
        <h2>Holle Purple Panther Porridge with Blueberries, Bananas and Apples</h2>
        ...
        <p id="pershkrimi">
     Pure perimesh me karrotë, kungull, kerri dhe arrë kokosi për fëmijët mbi 8 muaj. Pa sheqer, kripë, proteina qumështi, agjent lidhës, maja, vezë, laktozë dhe gluten. E çertifikuar Demeter.
        <div class="butonat">
            <button>-</button>
