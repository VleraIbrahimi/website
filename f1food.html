...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      ...
      <div class="info">
        <h2>Holle Bio Infant Goat Milk Formula 1 0m+ 400 g</h2>
        ...
        <p id="pershkrimi">
      Kjo formulë e parë e qumështit për foshnjat është e përshtatshme për ushqyerjen speciale të foshnjave që nga lindja kur ato nuk ushqehen ose nuk ushqehen mjaftueshëm me gji.
        <div class="butonat">
            <button>-</button>
