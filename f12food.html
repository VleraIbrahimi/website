...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="food12.png" alt="">
      </div>

      <div class="info">
        <h2>Plasmon Kos me Kajsi 6m+ 240 g</h2>
        ...
        <p id="pershkrimi">
      Kos me shije kajsie, i pasur me kalcium, vitamina dhe fermentet laktike të pasterizuar, pa ngjyrues dhe konservantë, burim i vitaminës C.
        <div class="butonat">
            <button>-</button>
