...
<body>
  ...
  <header>
    ...
    <section class="product-page">
      <div class="imazhi">
        <img src="suplimente8.png" alt="">
      </div>

      <div class="info">
        <h2>Together Health Pregnancy x 60 Kapsula</h2>
        ...
        <p id="pershkrimi">
       U prezantojmë Pregnancy nga Together Health – një suplement multivitaminë dhe mineral i krijuar posaçërisht për shtatzëninë dhe gjidhënien , sipas rekomandimeve të Agjencisë Europiane të Standardeve Ushqimore
        <div class="butonat">
            <button>-</button>
